{
  programs.btop = {
    ...
    settings = {
      ...
      # Set to true to force tty mode regardless of whether a real tty has been detected or not.
      ...
      presets = "cpu:1:default,proc:0:default cpu:0:default,mem:0:default,net:0:default cpu:0:block";
      ...
      # Graph symbol to use for graphs in memory box.
      # "default", "braille", "block" or "tty"
      graph_symbol_mem = "default";

      # Graph symbol to use for graphs in network box.
      # "default", "braille", "block" or "tty"
      graph_symbol_net = "default";

      # Graph symbol to use for graphs in processes box.
      # "default", "braille", "block" or "tty"
      ...
      # Recommended 2000 ms or above for better sample times for graphs.
      update_ms = 2000;
      ...
      # Can be needed on certain cpus to get correct temperature for correct core.
      ...
      # Available values: "celsius", "fahrenheit", "kelvin" and "rankine".
      temp_scale = "celsius";

      # Use base 10 for bits/bytes sizes.
      ...
      # Set this to false if the menus is flickering too much for comfort.
      ...
      # Begin line with "exclude=" to change to exclude filter, otherwise defaults to "most include" filter.
      ...
      # Use format "mountpoint:speed" separate disks with whitespace " ".
      # Example: "/mnt/media:100 /:20 /boot:1".
      io_graph_speeds = "";

      # Set fixed values for network graphs in Mebibits.
      # Is only used if net_auto is also set to false.
      net_download = 100;

      net_upload = 100;

      # Use network graphs auto rescaling mode
      # Ignores any values set above and rescales down to 10 Kibibytes at the lowest.
      net_auto = true;
