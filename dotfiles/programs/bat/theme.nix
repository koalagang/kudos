...
{
  home.file."${config.xdg.configHome}/bat/themes/custom.tmTheme".text = ''
      ...
      <dict>
        ...
        <array>
          ...
          <dict>
            ...
            <dict>
              <key>foreground</key>
              <string>#${config.colorScheme.palette.base09}</string>
            </dict>
          </dict>
          <dict>
            <key>scope</key>
          ...
          <dict>
            ...
            <dict>
              <key>foreground</key>
              <string>#${config.colorScheme.palette.base0C}</string>
            </dict>
          </dict>
          <dict>
            <key>scope</key>
