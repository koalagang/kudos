...

{
  ...
  # As such, I've added them in myself.
  # Additionally, I've removed all the Norwegian parrot tests
  # because nix does not allow for using the same option more than once.
  ...
  # disable annoying pin
  "browser.tabs.firefox-view" = false;

  # don't check if Firefox is the default browser
  "browser.shell.checkDefaultBrowser" = false;

  # disable unexpected system load telemetry
  "dom.security.unexpected_system_load_telemetry_enabled" = false;

  # disable titlebar
  # I do this because the minimise and maximise buttons are useless on tiling window managers
  # and the close button is unnecessary when I can just hit ctrl+q
  ...
  # this is simply because I manage my add-ons with nix (NUR)
  ...
  # For any options below here, if they were set by default, you'll see just one tab.
  # If they were not set by default but I uncommented them, you'll see several.
  # For example, see the options under 0712: set DoH provider.
  ...
  ***/
  ...
  "browser.urlbar.dnsResolveSingleWordsAfterSearch" = 0; # [DEFAULT: 0 FF104+]
