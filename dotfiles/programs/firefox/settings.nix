...

{
  programs.firefox.profiles.profile0.settings = {
    ...
    # For any options below here, if they were not set by default but I uncommented them,
    # you'll see several extra tabs. For example, see the options under 0712: set DoH provider.
