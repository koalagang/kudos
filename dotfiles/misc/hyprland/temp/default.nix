...

{
  ...
  home.file."${config.xdg.configHome}/waybar" = {
    source = config.lib.file.mkOutOfStoreSymlink "/home/dante/Desktop/git/kudos/dotfiles/misc/hyprland/temp/waybar";
    recursive = true;
  };

  home.file."${config.xdg.configHome}/fuzzel/fuzzel.ini" = {
    source = config.lib.file.mkOutOfStoreSymlink "/home/dante/Desktop/git/kudos/dotfiles/misc/hyprland/temp/fuzzel.ini";
  };
